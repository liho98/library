  ...
  <div id="edit-book">
    ...
    <v-container align-center>
      <v-form ref="form" v-model="valid">
        <v-layout row>
          <v-flex xs2 text-xs-right>Title</v-flex>
          <v-flex xs8>
            <v-text-field
              type="text"
              v-model="title"
        ...
        <v-layout row>
          <v-flex xs2 text-xs-right>Author</v-flex>
          <v-flex xs8>
            <v-text-field
              type="text"
              v-model="author"
        ...
        <v-layout row>
          <v-flex xs2 text-xs-right>Publisher</v-flex>
          <v-flex xs8>
            <v-text-field
              type="text"
              v-model="publisher"
        ...
        <v-layout row>
          <v-flex xs2 text-xs-right>Year</v-flex>
          <v-flex xs8>
            <v-text-field type="number" v-model="year" required></v-text-field>
          </v-flex>
        </v-layout>
        <v-layout row>
          <v-flex xs12 text-xs-center>
            <v-btn centered color="primary" :disabled="!valid" @click="updateBook">submit</v-btn>
  ...
  methods: {
    ...
    rowSelected(items) {
      ...
      document.getElementById(
        "updateBookAuthor"
      ).value = this.selected[0].author;
      document.getElementById(
        "updateBookPublisher"
      ).value = this.selected[0].publisher;
