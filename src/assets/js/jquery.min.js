!(function(e, t) {
  ...
  function o(e, t, n) {
    return gt.isFunction(t)
      ? gt.grep(e, function(e, r) {
          return !!t.call(e, r, e) !== n;
        })
      : t.nodeType
      ? gt.grep(e, function(e) {
          return (e === t) !== n;
        })
      : "string" != typeof t
      ? gt.grep(e, function(e) {
  ...
  function s(e) {
    var t = {};
    return (
      gt.each(e.match(qt) || [], function(e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function c(e, t, n, r) {
    var i;
    try {
      e && gt.isFunction((i = e.promise))
        ? i
            .call(e)
            .done(t)
            .fail(n)
        : e && gt.isFunction((i = e.then))
        ? i.call(e, t, n)
  ...
  function f() {
    nt.removeEventListener("DOMContentLoaded", f),
  ...
  function h(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((r = "data-" + t.replace(It, "-$&").toLowerCase()),
        (n = e.getAttribute(r)),
        "string" == typeof n)
      ) {
        try {
    ...
    for (var n, r, i = [], o = 0, a = e.length; a > o; o++)
      (r = e[o]),
        r.style &&
          ...
          t
            ? ("none" === n &&
                ((i[o] = Pt.get(r, "display") || null),
                i[o] || (r.style.display = "")),
              "" === r.style.display && _t(r) && (i[o] = m(r)))
            : "none" !== n && ((i[o] = "none"), Pt.set(r, "display", n)));
    ...
    return (
      (n =
        "undefined" != typeof e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && i(e, t)) ? gt.merge([e], n) : n
    );
  }
  function x(e, t) {
  ...
  function b(e, t, n, r, i) {
        ...
        if ("object" === gt.type(o)) gt.merge(p, o.nodeType ? [o] : o);
          ...
          for (
            a = a || f.appendChild(t.createElement("div")),
              ...
              u = Yt[s] || Yt._default,
              a.innerHTML = u[1] + gt.htmlPrefilter(o) + u[2],
              c = u[0];
            c--;
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && gt.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = gt.contains(o.ownerDocument, o)),
  ...
  function D(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Pt.hasData(e) &&
        ((o = Pt.access(e)), (a = Pt.set(t, o)), (l = o.events))
      ) {
      ...
      Rt.hasData(e) &&
        ((s = Rt.access(e)), (u = gt.extend({}, s)), Rt.set(t, u));
    }
  }
  function j(e, t) {
  ...
  function A(e, t, r, i) {
    ...
    var o,
      ...
      h = t[0],
      g = gt.isFunction(h);
    if (g || (p > 1 && "string" == typeof h && !dt.checkClone && rn.test(h)))
    ...
    if (
      ...
      for (s = gt.map(y(o, "script"), S), u = s.length; p > f; f++)
        (l = o),
          f !== d &&
            ((l = gt.clone(l, !0, !0)), u && gt.merge(s, y(l, "script"))),
          r.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, gt.map(s, N), f = 0; u > f; f++)
          (l = s[f]),
            Gt.test(l.type || "") &&
              !Pt.access(l, "globalEval") &&
              gt.contains(c, l) &&
              (l.src
                ? gt._evalUrl && gt._evalUrl(l.src)
                : n(l.textContent.replace(an, ""), c));
    }
    return e;
  }
  function q(e, t, n) {
    for (var r, i = t ? gt.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || gt.cleanData(y(r)),
        r.parentNode &&
          (n && gt.contains(r.ownerDocument, r) && x(y(r, "script")),
  ...
  function L(e, t, n) {
    ...
    return (
      ...
      n &&
        ...
        "" !== a || gt.contains(e.ownerDocument, e) || (a = gt.style(e, t)),
        !dt.pixelMarginRight() &&
          un.test(a) &&
          sn.test(t) &&
          ((r = s.width),
  ...
  function R(e, t, n, r, i) {
    ...
    for (
      ...
      "margin" === n && (a += gt.css(e, n + Bt[o], !0, i)),
        r
          ? ("content" === n && (a -= gt.css(e, "padding" + Bt[o], !0, i)),
            "margin" !== n &&
              (a -= gt.css(e, "border" + Bt[o] + "Width", !0, i)))
          : ((a += gt.css(e, "padding" + Bt[o], !0, i)),
            "padding" !== n &&
              (a += gt.css(e, "border" + Bt[o] + "Width", !0, i)));
    return a;
  }
  function M(e, t, n) {
    ...
    return un.test(o)
      ? o
      : ((r = a && (dt.boxSizingReliable() || o === e.style[t])),
        "auto" === o && (o = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (o = parseFloat(o) || 0),
        o + R(e, t, n || (a ? "border" : "content"), r, i) + "px");
  }
  ...
  function W() {
    vn &&
      (nt.hidden === !1 && e.requestAnimationFrame
        ? e.requestAnimationFrame(W)
        : e.setTimeout(W, gt.fx.interval),
      gt.fx.tick());
  }
  function $() {
    return (
  ...
  function B(e, t) {
    ...
    for (t = t ? 1 : 0; 4 > r; r += 2 - t)
      (n = Bt[r]), (i["margin" + n] = i["padding" + n] = e);
      ...
      for (r in d)
        u ||
          (m
            ...
            : (m = Pt.access(e, "fxshow", { display: l })),
          o && (m.hidden = !g),
          g && v([e], !0),
          p.done(function() {
  ...
  function U(e, t, n) {
    var r,
      ...
      l = s.promise({
        ...
        opts: gt.extend(
          !0,
          { specialEasing: {}, easing: gt.easing._default },
          n
        ),
    ...
    for (X(c, l.opts.specialEasing); a > o; o++)
      if ((r = U.prefilters[o].call(l, e, c, l.opts)))
        return (
          gt.isFunction(r.stop) &&
            (gt._queueHooks(l.elem, l.opts.queue).stop = gt.proxy(r.stop, r)),
          r
        );
    return (
      gt.map(c, _, l),
      gt.isFunction(l.opts.start) && l.opts.start.call(e, l),
      l
        .progress(l.opts.progress)
        .done(l.opts.done, l.opts.complete)
        .fail(l.opts.fail)
        .always(l.opts.always),
      gt.fx.timer(gt.extend(u, { elem: e, anim: l, queue: l.opts.queue })),
      l
    );
  }
  function V(e) {
  ...
  (gt.fn = gt.prototype = {
    ...
    (gt.extend = gt.fn.extend = function() {
      ...
      for (
        "boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++),
          "object" == typeof a || gt.isFunction(a) || (a = {}),
          s === u && ((a = this), s--);
        u > s;
        s++
      )
        if (null != (e = arguments[s]))
          for (t in e)
            (n = a[t]),
              (r = e[t]),
              a !== r &&
                (l && r && (gt.isPlainObject(r) || (i = Array.isArray(r)))
                  ? (i
                      ? ((i = !1), (o = n && Array.isArray(n) ? n : []))
                      : (o = n && gt.isPlainObject(n) ? n : {}),
                    (a[t] = gt.extend(l, o, r)))
                  : void 0 !== r && (a[t] = r));
      return a;
    }),
    gt.extend({
      ...
      isPlainObject: function(e) {
        ...
        return !(
          !e ||
          "[object Object]" !== lt.call(e) ||
          ((t = rt(e)) &&
            ((n = ct.call(t, "constructor") && t.constructor),
            "function" != typeof n || ft.call(n) !== pt))
        );
      },
      ...
      makeArray: function(e, t) {
        ...
        return (
          null != e &&
            (r(Object(e))
              ? gt.merge(n, "string" == typeof e ? [e] : e)
              : at.call(n, e)),
          n
        );
      },
      ...
      proxy: function(e, t) {
        ...
        return (
          ...
          gt.isFunction(e)
            ? ((r = it.call(arguments, 2)),
              (i = function() {
                return e.apply(t || this, r.concat(it.call(arguments)));
              }),
              (i.guid = e.guid = e.guid || gt.guid++),
              i)
            : void 0
        );
      },
    ...
    "function" == typeof Symbol &&
      (gt.fn[Symbol.iterator] = tt[Symbol.iterator]),
    gt.each(
          ...
          ? t.parentNode && t.disabled === !1
            ? "label" in t
              ? "label" in t.parentNode
                ...
                : t.disabled === e
              : t.isDisabled === e || (t.isDisabled !== !e && Et(t) === e)
            : t.disabled === e
    ...
    (T = t.support = {}),
      ...
      (L = t.setDocument = function(e) {
        ...
        return r !== H && 9 === r.nodeType && r.documentElement
          ? ((H = r),
            ...
            (T.getElementsByClassName = mt.test(H.getElementsByClassName)),
            ...
            (R = []),
            (P = []),
            (T.qsa = mt.test(H.querySelectorAll)) &&
              (i(function(e) {
            ...
            (t = mt.test(F.compareDocumentPosition)),
            (I =
              t || mt.test(F.contains)
                ? function(e, t) {
      ...
      (C = t.selectors = {
        ...
        preFilter: {
          ATTR: function(e) {
            return (
              (e[1] = e[1].replace(xt, bt)),
              (e[3] = (e[3] || e[4] || e[5] || "").replace(xt, bt)),
              "~=" === e[2] && (e[3] = " " + e[3] + " "),
              e.slice(0, 4)
            );
          },
      ...
      (D = t.select = function(e, t, n, r) {
        ...
        if (((n = n || []), 1 === c.length)) {
          if (
            ...
            if (
              ((t = (C.find.ID(a.matches[0].replace(xt, bt), t) || [])[0]), !t)
            )
              return n;
            l && (t = t.parentNode), (e = e.slice(o.shift().value.length));
          }
          for (
            i = dt.needsContext.test(e) ? 0 : o.length;
            ...
            if (
              (u = C.find[s]) &&
              (r = u(
                a.matches[0].replace(xt, bt),
                (yt.test(o[0].type) && f(t.parentNode)) || t
              ))
            ) {
  ...
  (gt.filter = function(e, t, n) {
    ...
    return (
      ...
      1 === t.length && 1 === r.nodeType
        ? gt.find.matchesSelector(r, e)
          ? [r]
          : []
        : gt.find.matches(
            e,
            gt.grep(t, function(e) {
              return 1 === e.nodeType;
            })
          )
    );
    ...
    gt.fn.extend({
      find: function(e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            gt(e).filter(function() {
              for (t = 0; r > t; t++) if (gt.contains(i[t], this)) return !0;
            })
          );
      ...
      is: function(e) {
        return !!o(
          this,
          "string" == typeof e && Ct.test(e) ? gt(e) : e || [],
          !1
        ).length;
      }
    });
  var St,
    ...
    Dt = (gt.fn.init = function(e, t, n) {
      ...
      if (((n = n || St), "string" == typeof e)) {
        ...
        if (r[1]) {
          if (
            ((t = t instanceof gt ? t[0] : t),
            gt.merge(
              this,
              gt.parseHTML(
                r[1],
                t && t.nodeType ? t.ownerDocument || t : nt,
                !0
              )
            ),
            Et.test(r[1]) && gt.isPlainObject(t))
          )
            for (r in t)
              gt.isFunction(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
          return this;
        }
        return (
          (i = nt.getElementById(r[2])),
  ...
  gt.fn.extend({
    has: function(e) {
      ...
      return this.filter(function() {
        for (var e = 0; n > e; e++) if (gt.contains(this, t[e])) return !0;
      });
    },
        ...
        for (; i > r; r++)
          for (n = this[r]; n && n !== t; n = n.parentNode)
            if (
              ...
              (a
                ? a.index(n) > -1
                : 1 === n.nodeType && gt.find.matchesSelector(n, e))
            ) {
              o.push(n);
              break;
            }
      ...
      function(e, t) {
        gt.fn[e] = function(n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (At[e] || gt.uniqueSort(i), jt.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (gt.Callbacks = function(e) {
    ...
    var t,
      ...
      c = {
              ...
              (function r(t) {
                gt.each(t, function(t, n) {
                  gt.isFunction(n)
                    ...
                    : n && n.length && "string" !== gt.type(n) && r(n);
                });
              })(arguments),
              n && !t && l()),
            this
        ...
        remove: function() {
          return (
            gt.each(arguments, function(e, t) {
              for (var n; (n = gt.inArray(t, o, n)) > -1; )
                o.splice(n, 1), u >= n && u--;
            }),
            this
          );
            ...
            then: function(t, r, i) {
              function o(t, n, r, i) {
                return function() {
                    ...
                    p = i
                      ...
                      : function() {
                          try {
                            ...
                            gt.Deferred.exceptionHook &&
                              gt.Deferred.exceptionHook(e, p.stackTrace),
                              t + 1 >= a &&
                                (r !== l && ((s = void 0), (c = [e])),
                                n.rejectWith(s, c));
                          }
                  ...
                  t
                    ? p()
                    : (gt.Deferred.getStackHook &&
                        (p.stackTrace = gt.Deferred.getStackHook()),
                      e.setTimeout(p));
                };
              }
              var a = 0;
              return gt
                .Deferred(function(e) {
                  n[0][3].add(o(0, e, gt.isFunction(i) ? i : u, e.notifyWith)),
                    n[1][3].add(o(0, e, gt.isFunction(t) ? t : u)),
                    n[2][3].add(o(0, e, gt.isFunction(r) ? r : l));
                })
                .promise();
            },
            promise: function(e) {
      ...
      when: function(e) {
        var t = arguments.length,
          ...
          a = function(e) {
            return function(n) {
              (r[e] = this),
                (i[e] = arguments.length > 1 ? it.call(arguments) : n),
                --t || o.resolveWith(r, i);
            };
          };
        if (
  ...
  (gt.fn.ready = function(e) {
    ...
    gt.extend({
      ...
      readyWait: 1,
      ready: function(e) {
        (e === !0 ? --gt.readyWait : gt.isReady) ||
          ((gt.isReady = !0),
          (e !== !0 && --gt.readyWait > 0) || Ht.resolveWith(nt, [gt]));
      }
    }),
    (gt.ready.then = Ht.then),
    "complete" === nt.readyState ||
    ("loading" !== nt.readyState && !nt.documentElement.doScroll)
      ? e.setTimeout(gt.ready)
      : (nt.addEventListener("DOMContentLoaded", f),
  ...
  (p.uid = 1),
    (p.prototype = {
      ...
      set: function(e, t, n) {
        ...
        else for (r in t) i[gt.camelCase(r)] = t[r];
        return i;
      },
      get: function(e, t) {
        return void 0 === t
          ? this.cache(e)
          : e[this.expando] && e[this.expando][gt.camelCase(t)];
      },
      ...
      remove: function(e, t) {
        ...
        if (void 0 !== r) {
          if (void 0 !== t) {
            Array.isArray(t)
              ? (t = t.map(gt.camelCase))
              : ((t = gt.camelCase(t)), (t = t in r ? [t] : t.match(qt) || [])),
              (n = t.length);
            for (; n--; ) delete r[t[n]];
          }
          (void 0 === t || gt.isEmptyObject(r)) &&
    ...
    gt.fn.extend({
      data: function(e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = Rt.get(o)), 1 === o.nodeType && !Pt.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
                0 === r.indexOf("data-") &&
                  ((r = gt.camelCase(r.slice(5))), h(o, r, i[r])));
      ...
      queue: function(e, t, n) {
        ...
        return e
          ? ((t = (t || "fx") + "queue"),
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = Pt.access(e, t, gt.makeArray(n)))
                : r.push(n)),
            r || [])
          : void 0;
      },
        ...
        return (
          ...
          arguments.length < n
            ...
            : this.each(function() {
                ...
                gt._queueHooks(this, e),
                  "fx" === e && "inprogress" !== n[0] && gt.dequeue(this, e);
              })
        );
      },
      dequeue: function(e) {
    ...
    _t = function(e, t) {
      return (
        ...
        "none" === e.style.display ||
          ("" === e.style.display &&
            gt.contains(e.ownerDocument, e) &&
            "none" === gt.css(e, "display"))
      );
    },
    zt = function(e, t, n, r) {
      var i,
  ...
  (gt.event = {
      ...
      if (m)
        for (
          n.handler && ((o = n), (n = o.handler), (i = o.selector)),
            i && gt.find.matchesSelector(Jt, i),
            n.guid || (n.guid = gt.guid++),
            (u = m.events) || (u = m.events = {}),
            (a = m.handle) ||
              (a = m.handle = function(t) {
                return "undefined" != typeof gt && gt.event.triggered !== t.type
                  ? gt.event.dispatch.apply(e, arguments)
                  : void 0;
              }),
            t = (t || "").match(qt) || [""],
            l = t.length;
          ...
          if (
            ...
            a &&
              ...
              ((f.teardown && f.teardown.call(e, h, m.handle) !== !1) ||
                gt.removeEvent(e, d, m.handle),
              delete u[d]);
          } else for (d in u) gt.event.remove(e, d + t[l], n, r, !0);
    ...
    dispatch: function(e) {
      ...
      if (
        ...
        for (
          a = gt.event.handlers.call(this, s, l), t = 0;
          ...
          for (
            ...
            (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
              ...
              (s.data = o.data),
              (r = (
                (gt.event.special[o.origType] || {}).handle || o.handler
              ).apply(i.elem, u)),
              void 0 !== r &&
                (s.result = r) === !1 &&
    ...
    special: {
      ...
      click: {
        trigger: function() {
          return "checkbox" === this.type && this.click && i(this, "input")
            ? (this.click(), !1)
            : void 0;
        },
        _default: function(e) {
    ...
    (gt.Event = function(e, t) {
      return this instanceof gt.Event
        ? (e && e.type
            ...
            : (this.type = e),
          t && gt.extend(this, t),
          (this.timeStamp = (e && e.timeStamp) || gt.now()),
    ...
    gt.each(
      {
        ...
        which: function(e) {
          var t = e.button;
          return null == e.which && Kt.test(e.type)
            ? null != e.charCode
              ? e.charCode
              : e.keyCode
            : !e.which && void 0 !== t && Zt.test(e.type)
            ? 1 & t
              ? 1
              : 2 & t
              ? 3
  ...
  gt.extend({
    ...
    clone: function(e, t, n) {
      ...
      if (t)
        if (n)
          for (o = o || y(e), a = a || y(s), r = 0, i = o.length; i > r; r++)
            D(o[r], a[r]);
        else D(e, s);
      return (
      ...
      for (var t, n, r, i = gt.event.special, o = 0; void 0 !== (n = e[o]); o++)
        if (Ot(n)) {
          if ((t = n[Pt.expando])) {
            if (t.events)
              for (r in t.events)
                i[r] ? gt.event.remove(n, r) : gt.removeEvent(n, r, t.handle);
            n[Pt.expando] = void 0;
          }
    ...
    gt.fn.extend({
      ...
      empty: function() {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (gt.cleanData(y(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function(e, t) {
        return (
            ...
            if (
              ...
              try {
                for (; r > n; n++)
                  (t = this[n] || {}),
                    1 === t.nodeType &&
                      (gt.cleanData(y(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (i) {}
            }
      ...
      replaceWith: function() {
        ...
        return A(
          ...
          function(t) {
            ...
            gt.inArray(this, e) < 0 &&
              (gt.cleanData(y(this)), n && n.replaceChild(t, this));
          },
          e
        );
      }
    ...
    gt.each(
      ...
      function(e, t) {
        gt.fn[e] = function(e) {
          for (var n, r = [], i = gt(e), o = i.length - 1, a = 0; o >= a; a++)
  ...
  gt.extend({
      ...
      gt.cssHooks[t] = {
        ...
        set: function(e, n, r) {
          var i,
            ...
            a =
              r &&
              R(e, t, r, "border-box" === gt.css(e, "boxSizing", !1, o), o);
          return (
            a &&
              (i = $t.exec(n)) &&
              "px" !== (i[3] || "px") &&
              ((e.style[t] = n), (n = gt.css(e, t))),
            P(e, n, a)
          );
        }
      };
    ...
    gt.each({ margin: "", padding: "", border: "Width" }, function(e, t) {
      (gt.cssHooks[e + t] = {
        expand: function(n) {
          for (
        ...
        return Ft(
          ...
          function(e, t, n) {
            var r,
              ...
              a = 0;
            if (Array.isArray(t)) {
              for (r = ln(e), i = t.length; i > a; a++)
                o[t[a]] = gt.css(e, t[a], !1, r);
              return o;
            }
      ...
      _default: {
        get: function(e) {
          ...
          return 1 !== e.elem.nodeType ||
            ...
            ? e.elem[e.prop]
            : ((t = gt.css(e.elem, e.prop, "")), t && "auto" !== t ? t : 0);
        },
        set: function(e) {
          gt.fx.step[e.prop]
            ? gt.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (null == e.elem.style[gt.cssProps[e.prop]] &&
                !gt.cssHooks[e.prop])
            ? (e.elem[e.prop] = e.now)
            : gt.style(e.elem, e.prop, e.now + e.unit);
        }
      }
    }),
      ...
      return (
        gt.fx.off
          ...
          : "number" != typeof r.duration &&
            (r.duration =
              r.duration in gt.fx.speeds
                ? gt.fx.speeds[r.duration]
                : gt.fx.speeds._default),
      ...
      stop: function(e, t, n) {
        ...
        return (
          ...
          this.each(function() {
            ...
            else for (i in a) a[i] && a[i].stop && xn.test(i) && r(a[i]);
            for (i = o.length; i--; )
              o[i].elem !== this ||
                (null != e && o[i].queue !== e) ||
      ...
      attr: function(e, t, n) {
        ...
        return 3 !== o && 8 !== o && 2 !== o
          ? "undefined" == typeof e.getAttribute
            ...
            : ((1 === o && gt.isXMLDoc(e)) ||
                (i =
                  gt.attrHooks[t.toLowerCase()] ||
                  (gt.expr.match.bool.test(t) ? bn : void 0)),
              void 0 !== n
                ? null === n
                  ? void gt.removeAttr(e, t)
                  : i && "set" in i && void 0 !== (r = i.set(e, n, t))
                  ? r
                  : (e.setAttribute(t, n + ""), n)
                : i && "get" in i && null !== (r = i.get(e, t))
                ? r
                : ((r = gt.find.attr(e, t)), null == r ? void 0 : r))
          : void 0;
      },
      attrHooks: {
        type: {
  ...
  gt.fn.extend({
    ...
    gt.extend({
      prop: function(e, t, n) {
        ...
        return 3 !== o && 8 !== o && 2 !== o
          ? ((1 === o && gt.isXMLDoc(e)) ||
              ((t = gt.propFix[t] || t), (i = gt.propHooks[t])),
            void 0 !== n
              ? i && "set" in i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
      ...
      propHooks: {
        tabIndex: {
          get: function(e) {
            ...
            return t
              ? parseInt(t, 10)
              : Tn.test(e.nodeName) || (Cn.test(e.nodeName) && e.href)
              ? 0
              : -1;
          }
        }
      ...
      return arguments.length
        ? ((r = gt.isFunction(e)),
          this.each(function(n) {
            var i;
            1 === this.nodeType &&
              ((i = r ? e.call(this, n, gt(this).val()) : e),
              null == i
                ? (i = "")
                : "number" == typeof i
                ? (i += "")
                : Array.isArray(i) &&
                  (i = gt.map(i, function(e) {
                    return null == e ? "" : e + "";
                  })),
              (t =
                gt.valHooks[this.type] ||
                gt.valHooks[this.nodeName.toLowerCase()]),
              (t && "set" in t && void 0 !== t.set(this, i, "value")) ||
                (this.value = i));
          }))
        : i
        ? ((t = gt.valHooks[i.type] || gt.valHooks[i.nodeName.toLowerCase()]),
    ...
    gt.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function(e, t) {
            for (
              var n, r, i = e.options, o = gt.makeArray(t), a = i.length;
              a--;

            )
              (r = i[a]),
                (r.selected = gt.inArray(gt.valHooks.option.get(r), o) > -1) &&
                  (n = !0);
      ...
      (gt.valHooks[this] = {
        set: function(e, t) {
          return Array.isArray(t)
            ? (e.checked = gt.inArray(gt(e).val(), t) > -1)
            : void 0;
        }
      }),
        dt.checkOn ||
          (gt.valHooks[this].get = function(e) {
  ...
  gt.extend(gt.event, {
    ...
    simulate: function(e, t, n) {
      var r = gt.extend(new gt.Event(), n, { type: e, isSimulated: !0 });
    ...
    dt.focusin ||
      gt.each({ focus: "focusin", blur: "focusout" }, function(e, t) {
        var n = function(e) {
        ...
        gt.event.special[t] = {
          ...
          teardown: function() {
            ...
            i
              ? Pt.access(r, t, i)
              : (r.removeEventListener(e, n, !0), Pt.remove(r, t));
          }
        };
      });
  var Sn = e.location,
  ...
  (gt.param = function(e, t) {
    ...
    if (Array.isArray(e) || (e.jquery && !gt.isPlainObject(e)))
      gt.each(e, function() {
  ...
  (_n.href = Sn.href),
    gt.extend({
      ...
      ajax: function(t, n) {
        ...
        if (
          (v.promise(C),
          (h.url = ((t || h.url || Sn.href) + "").replace(
            In,
            Sn.protocol + "//"
          )),
          (h.type = n.method || n.type || h.method || h.type),
          (h.dataTypes = (h.dataType || "*").toLowerCase().match(qt) || [""]),
          null == h.crossDomain)
        ) {
          ...
          try {
            (l.href = h.url),
              (l.href = l.href),
              (h.crossDomain =
                _n.protocol + "//" + _n.host != l.protocol + "//" + l.host);
          } catch (E) {
            h.crossDomain = !0;
          }
        }
        if (
          (h.data &&
            ...
            (h.data = gt.param(h.data, h.traditional)),
          J(Wn, h, n, C),
          c)
        )
          return C;
        (f = gt.event && h.global),
          f && 0 === gt.active++ && gt.event.trigger("ajaxStart"),
          ...
          h.hasContent
            ...
            : ((d = h.url.slice(o.length)),
              h.data &&
                ((o += (Dn.test(o) ? "&" : "?") + h.data), delete h.data),
              h.cache === !1 &&
                ((o = o.replace(On, "$1")),
                (d = (Dn.test(o) ? "&" : "?") + "_=" + Nn++ + d)),
              (h.url = o + d)),
          h.ifModified &&
            (gt.lastModified[o] &&
              C.setRequestHeader("If-Modified-Since", gt.lastModified[o]),
    ...
    gt.each(["get", "post"], function(e, t) {
      gt[t] = function(e, n, r, i) {
        return (
          gt.isFunction(n) && ((i = i || r), (r = n), (n = void 0)),
          gt.ajax(
            gt.extend(
    ...
    gt.fn.extend({
      wrapAll: function(e) {
        ...
        return (
          this[0] &&
            (gt.isFunction(e) && (e = e.call(this[0])),
            (t = gt(e, this[0].ownerDocument)
              .eq(0)
              .clone(!0)),
  ...
  (dt.cors = !!Xn && "withCredentials" in Xn),
    (dt.ajax = Xn = !!Xn),
  ...
  gt.ajaxSetup({
    ...
    gt.ajaxPrefilter("json jsonp", function(t, n, r) {
      ...
      return s || "jsonp" === t.dataTypes[0]
        ? ((i = t.jsonpCallback = gt.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
            ? (t[s] = t[s].replace(Vn, "$1" + i))
            : t.jsonp !== !1 &&
              (t.url += (Dn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
          ...
          r.always(function() {
            void 0 === o ? gt(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), Un.push(i)),
              a && gt.isFunction(o) && o(a[0]),
              (a = o = void 0);
          }),
          "script")
        : void 0;
      ...
      return (
        t ||
          (dt.createHTMLDocument
            ? ((t = nt.implementation.createHTMLDocument("")),
              (r = t.createElement("base")),
              (r.href = nt.location.href),
    ...
    (gt.offset = {
      setOffset: function(e, t, n) {
        ...
        "static" === c && (e.style.position = "relative"),
          ...
          gt.isFunction(t) && (t = t.call(e, n, gt.extend({}, s))),
    ...
    gt.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function(
      e,
      t
    ) {
      var n = "pageYOffset" === t;
    ...
    gt.each(["top", "left"], function(e, t) {
      gt.cssHooks[t] = H(dt.pixelPosition, function(e, n) {
        return n
          ? ((n = L(e, t)), un.test(n) ? gt(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
    gt.each({ Height: "height", Width: "width" }, function(e, t) {
      gt.each({ padding: "inner" + e, content: t, "": "outer" + e }, function(
        n,
        r
      ) {
  ...
  var Gn = e.jQuery,
    Yn = e.$;
  return (
    (gt.noConflict = function(t) {
      return (
        e.$ === gt && (e.$ = Yn), t && e.jQuery === gt && (e.jQuery = Gn), gt
      );
    }),
    t || (e.jQuery = e.$ = gt),
    gt
